...
# ADDING THE BIOGRAPHY DICTIONARY
Biography = {
    # ADDING NAME
    'name' : 'ZERSHA',
    # ADDING HOMETOWN
...
#PRINTING VALUES WITH CONCATINATION AND MAKING SURE ALL THE VALUES ARE STRINGS
print(f'name: ' + str(Biography['name']) + "\n" +
      'hometown: ' + str(Biography['hometown']) + "\n" +
