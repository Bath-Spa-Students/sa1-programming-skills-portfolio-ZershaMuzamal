...
Multiple Questions: Extend the program into a quiz that asks for the capitals of 10 European countries. Provide feedback for each
question."""
#USING PRINT STATEMENT TO PRINT THE QUESTION
print("What is the capital of France?")
while True:
#TAKING ANSWER AS INPUT FROM THE USER
   ANSWER = input("Answer here:")
#USING IF AND ELSE STAEMENT 
   if ANSWER.lower() == "paris":
#PRINT STATEMENT FOR CORRECT ANSWER
      print("Correct! WOW YOU WON")
      break
   else:
